...
class GFSA_Attn_Timm(nn.Module):
    ...
    def forward(self, x):
        ...
        # ----- GFSA term -----
        h = self.order_h
        I = self._eye(N, attn.device, attn.dtype)[None, None, ...]  # (1,1,N,N)
        high_order = (h - 1) * (attn - I) @ attn
...
def graft_gfsa_into_timm(vit, order_h=4, renorm=False):
    """
...
class ASTModel(nn.Module):
    ...
    def __init__(self, label_dim=527, fstride=16, tstride=16, input_fdim=256, input_tdim=1024, imagenet_pretrain=True, audioset_pretrain=True, model_size='base384', verbose=True, mix_beta=None):
        ...
        # now load a model that is pretrained on both ImageNet and AudioSet
            ...
            out_dir = '/content/drive/MyDrive/MoCo/MVST/16/pretrained_models'
